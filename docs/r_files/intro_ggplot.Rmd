## ----echo=FALSE, out.width='75%', fig.align='center', fig.cap='[Source](https://github.com/allisonhorst/stats-illustrations/blob/master/rstats-artwork/ggplot2_masterpiece.png)'----
...
## ----echo=FALSE, out.width='100%', fig.align='center', fig.cap='Examples of `geom_*` functions'---------
knitr::include_graphics("figures/intro_r/geom_cheatsheet.png")


## ----echo=FALSE, out.width='100%', fig.align='center', fig.cap='Examples of packages that works as extension for `ggplot2`. From left to right `ggwordcloud`, `ggridges`, and `gggenes`'----
...
## ----echo=FALSE, out.width='50%', fig.align='center', fig.cap='Different shape options'-----------------
...
## ----echo=FALSE, out.width='75%', fig.align='center', fig.cap='Colors with the name build-in in R (left and center) and RGB scheme'----
...
## ----echo=FALSE, out.width='100%', fig.align='center', fig.cap='Print screen of colorbrewer2.org website. 1 - number of classes; 2 - type of data; 3 - pallet option; 4 - name of pallet and information for color blind, photocopy, LCD, and  printer friendly options'----
...
## ----echo=FALSE, out.width='100%', fig.align='center', fig.cap='Plot saved in the computer and upload to this document'----
